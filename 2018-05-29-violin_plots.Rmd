...
tags:
  - Data_Visualisation
  - plotting
summary: "Create beautifully simple violin/bean/pirate plots in R"
header:
  caption: ''
  image: '/violins/pokemon_all_pirate_plot.png'
---
***
## Overview
...
packages <- c("ggplot2","dplyr","gridExtra","grid","lattice","lazyeval","tidyr",
              ...
              "tidyr","broom", "yarrr", "knitr") # add packages to list as needed
...
q2 <- split_violin(data,
              ...
              main = "Pokemon Power and Generation", # plot title; set as NULL to remove
